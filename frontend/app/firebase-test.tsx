...
import DatabaseSeederComponent from '../components/DatabaseSeederComponent';
      ...
      <View style={{ padding: 20 }}>
        ...
        <View style={{ 
          ...
          <Text style={{ marginBottom: 5 }}>
            1. Click "Test Firebase Connection" to verify Firebase setup
          </Text>
          <Text style={{ marginBottom: 5 }}>
          ...
          <Text style={{ color: '#666', fontSize: 14, marginTop: 10 }}>
            Make sure your Firebase project is configured and Firestore is enabled.
          </Text>
        </View>
      </View>
    </ScrollView>
