    ...
    <ScrollView style={{ padding: 20, backgroundColor: '#f5f5f5' }}>
      <View style={{
        ...
        <Text style={{ marginBottom: 15, color: '#666', textAlign: 'center' }}>
          Use these buttons to populate your Firestore database with initial data
        </Text>
        ...
        <View style={{
          ...
          <Text style={{ color: '#856404', fontSize: 12, marginTop: 5 }}>
            This will create test data in your Firestore database. Make sure you're connected to the correct Firebase project.
          </Text>
        </View>
